...
!(function (a) {
  ...
  function o(a) {
    ...
    const c = (a.compatMode || "") === "CSS1Compat";
    const d = b
      ? window.pageXOffset
      : c
  ...
  function B(a, b, c) {
    ...
    const e = Math.ceil(Number(d.toFixed(3)) - 1);
    const f = c.xVal[a] + c.xNumSteps[a] * e;
  ...
  function Q(a, b) {
    ...
    const d = b.indexOf("drag") >= 0;
    const e = b.indexOf("fixed") >= 0;
    const f = b.indexOf("snap") >= 0;
    const g = b.indexOf("hover") >= 0;
    if (e) {
      if (a.handles !== 2) {
        throw new Error(
          `noUiSlider (${
  ...
  function Y(a, e, g) {
    ...
    function s(a, b) {
      const c = k(a, e.cssClasses.origin);
      const d = k(c, e.cssClasses.handle);
      return (
    ...
    function u(a, b) {
      ...
      for (let c = 0; c < e.handles; c++) ia.push(s(b, c)), (ra[c] = c), ja.push(t(b, a[c + 1]));
    }
    function v(a) {
    ...
    function y() {
      ea("update", (a, b, c, d, f) => {
        ra.forEach((a) => {
          const b = ia[a];
          const d = S(qa, a, 0, !0, !0, !0);
          const g = S(qa, a, 100, !0, !0, !0);
          const h = f[a];
          const i = e.ariaFormat.to(c[a]);
    ...
    function A(a, b, c) {
      ...
      const f = {};
      const g = ta.xVal[0];
      const h = ta.xVal[ta.xVal.length - 1];
      let i = !1;
      let j = !1;
      let k = 0;
      return (
        (c = d(
          c.slice().sort((a, b) => a - b)
        )),
    ...
    function D(a) {
      ...
      const g = z(b, e, f);
      const h = A(c, b, g);
      const i = a.format || { to: Math.round };
      return (la = pa.appendChild(B(h, d, i)));
    }
    function E() {
      const a = ha.getBoundingClientRect();
      const b = `offset${["Width", "Height"][e.ort]}`;
    ...
    function G(a, b) {
      let c;
      let d;
      const e = a.type.indexOf("touch") === 0;
      const f = a.type.indexOf("mouse") === 0;
      let g = a.type.indexOf("pointer") === 0;
    ...
    function M(a, b) {
      ...
      const c = (e.dir ? -1 : 1) * (a.calcPoint - b.startCalcPoint);
      const d = (100 * c) / b.baseSize;
    ...
    function O(a, b) {
      ...
      const g = F(ma.end, ya, N, { handleNumbers: b.handleNumbers });
      const h = F("mouseout", ya, L, { handleNumbers: b.handleNumbers });
      (wa = f.concat(g, h)),
      a.cursor
    ...
    function Q(a) {
      const b = H(a.calcPoint);
      const c = ta.getStep(b);
      const d = ta.fromStepping(c);
    ...
    function ca() {
      for (const a in e.cssClasses) e.cssClasses.hasOwnProperty(a) && m(pa, e.cssClasses[a]);
      for (; pa.firstChild;) pa.removeChild(pa.firstChild);
      delete pa.noUiSlider;
    }
    function da() {
      return qa.map((a, b) => {
        const c = ta.getNearbySteps(a);
        const d = ua[b];
        let e = c.thisStep.step;
        let f = null;
        e !== !1
    ...
    function fa(a) {
      const b = a && a.split(".")[0];
      const c = b && a.substring(b.length);
      Object.keys(va).forEach((a) => {
        const d = a.split(".")[0];
        const e = a.substring(d.length);
