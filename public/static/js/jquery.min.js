...
!(function (a, b) {
  ...
  n.extend({
    ...
    map(a, b, c) {
      ...
      let g = 0;
      const h = [];
      if (s(a)) for (d = a.length; d > g; g++) (e = b(a[g], g, c)), e != null && h.push(e);
  ...
  const t = (function (a) {
    ...
    return (
      ...
      ia((a) => ((
        ...
        || ja("type|href|height|width", (a, b, c) => (c
          ? void 0
      ...
      (c.attributes
        ...
        || ja("value", (a, b, c) => (c || a.nodeName.toLowerCase() !== "input"
          ? void 0
          : a.defaultValue)),
  ...
  ($.th = $.td);
  function _(a, b) {
    const c = typeof a.getElementsByTagName !== "undefined"
  ...
  n.fn.extend({
    ...
    empty() {
      for (var a, b = 0; (a = this[b]) != null; b++) a.nodeType === 1 && (n.cleanData(_(a, !1)), (a.textContent = ""));
      return this;
    },
    clone(a, b) {
      return (
  ...
  (n.cssHooks.marginLeft = Ga(l.reliableMarginLeft, (a, b) => (b
    ? `${parseFloat(Fa(a, "marginLeft"))
            || a.getBoundingClientRect().left
              - Da(a, { marginLeft: 0 }, () => a.getBoundingClientRect().left)}px`
    : void 0))),
  (n.cssHooks.marginRight = Ga(l.reliableMarginRight, (a, b) => (b
  ...
  function Za(a, b, c) {
    ...
    if (n.isEmptyObject(m)) (j === "none" ? za(a.nodeName) : j) === "inline" && (o.display = j);
    else {
  ...
  n.extend({
    ...
    ajax(b, c) {
      ...
      if (m.beforeSend && (m.beforeSend.call(o, x, m) === !1 || v === 2)) return x.abort();
      w = "abort";
      for (l in { success: 1, error: 1, complete: 1 }) x[l](m[l]);
      if ((e = xb(tb, m, c, x))) {
        if (((x.readyState = 1), k && p.trigger("ajaxSend", [x, m]), v === 2)) return x;
        m.async
          && m.timeout > 0
          && (i = a.setTimeout(() => {
            x.abort("timeout");
  ...
  n.each(["top", "left"], (a, b) => {
    n.cssHooks[b] = Ga(l.pixelPosition, (a, c) => (c
